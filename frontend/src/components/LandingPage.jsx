  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Join the revolution in sustainable waste management. Our AI-powered platform 
                connects communities, optimizes routes, and creates a cleaner future for everyone.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Whether you're a resident, administrator, or driver, we have the perfect 
              tools to help you contribute to a sustainable future.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 group-hover:border-emerald-200">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Resident</h3>
                <p className="text-gray-600 mb-8 leading-relaxed">
                  Schedule pickups, track collections, and receive smart notifications 
                  for seamless waste management at your doorstep.
                </p>
                <button
                  onClick={handleJoinUser}
            ...
            <div className="group relative">
              ...
              <div className="relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 group-hover:border-orange-200">
                ...
                <button onClick={()=>{navigate('/driverlogin')}} className="w-full bg-gradient-to-r from-orange-600 to-red-600 text-white py-3 rounded-xl font-semibold hover:shadow-lg hover:shadow-orange-500/25 transition-all duration-300">
                  Start Driving
                </button>
              </div>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-emerald-50 to-teal-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Why Choose CleanSweep?</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">AI-powered route optimization reduces fuel consumption and improves efficiency.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Promote recycling and sustainable practices for a greener tomorrow.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Monitor collections in real-time with live updates and notifications.</p>
            </div>
          </div>
        </div>
      </section>
