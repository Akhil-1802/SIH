...
export default function AdminDashboard() {
  ...
  const menuItems = [
    ...
    {
      id: "newusers",
      name: "Biodegradable waste registration",
      icon: UserPlus,
    },
  ];
    ...
    switch (activeTab) {
      ...
      case "newusers":
        return (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-gray-900">
              User Registration Requests for biodegradable Waste
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div
                ...
                className={`rounded-xl p-4 shadow-sm border text-center cursor-pointer transition-all ${
                  selectedUserStatus === "New Request"
                    ? "border-blue-300 bg-blue-50"
                    : "border-green-100 bg-white hover:bg-gray-50"
                }`}
              >
              ...
              <div
                ...
                className={`rounded-xl p-4 shadow-sm border text-center cursor-pointer transition-all ${
                  selectedUserStatus === "Pending Assignment"
                    ? "border-yellow-300 bg-yellow-50"
                    : "border-green-100 bg-white hover:bg-gray-50"
                }`}
              >
