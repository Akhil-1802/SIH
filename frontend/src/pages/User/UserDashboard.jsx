  ...
  return (
    <div className="flex min-h-screen bg-green-50">
      ...
      <aside className="w-72 bg-green-100 flex flex-col py-6 px-6 border-r">
        <span onClick={()=>{navigate('/userdashboard')}} className="font-bold text-2xl text-green-800 mb-5">EcoWaste</span>
        <nav className="flex flex-col gap-1">
          <button><SidebarButton active icon={<Bell className="mr-2" />} label="Notifications" /></button>
          <button onClick={()=>{navigate("/complaint")}}><SidebarButton  icon={<BookUser className="mr-2" />} label="Complaints" /></button>
